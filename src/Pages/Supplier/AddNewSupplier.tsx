...
import { useAddSupplier } from "../../apihooks/useUsers";
...
const AddNewSupplier: React.FC = () => {
  ...
  const { ADDSUPPLIER } = useApiRoutes();
  ...
  const sendData = async () => {
    ...
    try {
      ...
      if (response?.status === 1) {
        successToast(response.message || "Supplier added successfully");
        // Reset form
        setFormData({
          OrganisationID: '',
          OrganisationName: '',
        ...
        errorToast(response?.message || "Failed to add supplier");
      }
    } catch (error: any) {
      errorToast(
                      ...
                      <div className="mb-3 row align-items-center">
                        ...
                        <div className="col-md-9 col-lg-9">
                          <input 
                            ...
                            placeholder="e.g., ravi@techsupplies.com"
                          />
                          {errors.ContactEmail && (
                            <div className="invalid-feedback d-block">
                              {errors.ContactEmail}
